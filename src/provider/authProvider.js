...
export const authProvider = (app, config) => {
    return {
        login: async ({ username, password }) => {
            return await client
                .post(config.apiUrl + '/' + (config.resourcesPrefix ? app + '/' : '') + config.apiPath.login, {
                username: username,
                password: password,
            })
                .then((res) => {
        ...
        register: async ({ username, password }) => {
            return await client
                .post(config.apiUrl + '/' + (config.resourcesPrefix ? app + '/' : '') + config.apiPath.register, {
                username: username,
                password: password,
            })
                .then((res) => {
